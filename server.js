...
I can read it as text, an audio message or even a handwritten note!", function(){
    ...
    sendTextMessage(senderID, "FUN! I can send you random songs, videos, gifs and more if you'd like, or we can play 'the selfie game'\
 - ask me anything! More info at https://chatzer.herokuapp.com/ :P !", function(){});
...
if (postback === "getStarted") {
   ...
   mgraph.getuser(request, senderID, function(results){    
    ...
    introduce(senderID, first_name);
      ...
      text = postback.substring(postback.indexOf("* ") + 1);
