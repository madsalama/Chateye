...
module.exports = {
  ...
  detect: function(
    ...
    download(
      image,
      "./static/" + "" + senderID + "_" + timeOfMessage + ".jpg",
      function() {
        var image_path =
          "./static/" + "" + senderID + "_" + timeOfMessage + ".jpg";
        visionClient.detectFaces(image_path).then(results => {
          ...
          faces.forEach((face, i) => {
            values[i] = {
              ...
              underExposedLikelihood: JSON.stringify(
                faces[i].underExposedLikelihood
              ),
  ...
  getProminentColor: function(
    ...
    download(
      ...
      function() {
        ...
        visionClient.detectProperties(image_path).then(results => {
          values = results[0];
